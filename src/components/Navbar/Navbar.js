...
const Navbar = () => {
  return (
    <div><nav className="navbar navbar-expand-lg bg-light mb-4">
    <div className="container">
    <Link to="/" className="fs-3 ubuntu fw-bold navbar-brand">Rick &  Morty <span className="text-primary">Wiki</span></Link>
